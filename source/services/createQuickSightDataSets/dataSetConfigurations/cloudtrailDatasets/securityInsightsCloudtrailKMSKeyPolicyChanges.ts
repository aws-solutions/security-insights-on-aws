...
export const dataset = {
    DataSetId: 'Security_Insights_Cloudtrail_KMS_Key_Policy_Changes',
    Name: 'Security_Insights_Cloudtrail_KMS_Key_Policy_Changes',
    PhysicalTableMap: {
    ...
    LogicalTableMap: {
      '6bea002a-ef77-4a88-807a-004deed07d70': {
        Alias: 'Security_Insights_Cloudtrail_KMS_Key_Policy_Changes',
        DataTransforms: [
          {
            ProjectOperation: {
              ProjectedColumns: [
