...
export const dataset = {
    ...
    LogicalTableMap: {
      '6bea002a-ef77-4a88-807a-004deed07d70': {
        Alias: 'Security_Insights_Cloudtrail_Root_Login_Details',
        DataTransforms: [
          {
            ProjectOperation: {
              ProjectedColumns: [
