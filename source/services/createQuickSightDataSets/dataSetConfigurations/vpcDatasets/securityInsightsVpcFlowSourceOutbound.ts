...
export const dataset = {
    ...
    LogicalTableMap: {
      '9af48d85-a269-49e7-a031-5fcb09374936': {
        Alias: 'Security_Insights_Vpc_Flow_Source_Outbound',
        DataTransforms: [
          {
            ProjectOperation: {
              ProjectedColumns: [
